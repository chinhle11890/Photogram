...
class AddEvent: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private lazy var blackView: UIView = {
        ...
        blackView.addConstraintsWithFormat("H:[v0(40)]-20-|", views: image)
        blackView.addConstraintsWithFormat("V:[v0(40)]-20-|", views: image)
        
        let button = UIButton()
        button.addTarget(self, action: #selector(dismissView), for: .touchUpInside)
        blackView.addSubview(button)
        blackView.addConstraintsWithFormat("H:[v0(40)]-20-|", views: button)
        blackView.addConstraintsWithFormat("V:[v0(40)]-20-|", views: button)
