    ...
    override public func prepare(){
        ...
        for section in 0 ..< numberOfSections {
            ...
            */
            ...
            if heightHeader > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: CHTCollectionElementKindSectionHeader, with: NSIndexPath(item: 0, section: section) as IndexPath)
            ...
            */
            ...
            for idx in 0 ..< itemCount {
                ...
                let yOffset = (self.columnHeights[section] as! NSMutableArray).object(at: columnIndex)
                let itemSize = self.delegate?.collectionView(self.collectionView!, layout: self, sizeForItemAtIndexPath: indexPath)
                var itemHeight : CGFloat = 0.0
                if Int(itemSize!.height) > 0 && Int(itemSize!.width) > 0 {
                ...
                attributes.frame = CGRect(x: xOffset, y: yOffset as! CGFloat, width: itemWidth, height: itemHeight)
            ...
            */
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: CHTCollectionElementKindSectionFooter, with: NSIndexPath(item: 0, section: section) as IndexPath)
